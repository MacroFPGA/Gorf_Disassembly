...
;
; ----> _BARRAY   Calculates a jump target by adding a 16-bit offset to the
...
; NOTE: AI SPECULATION ONLY. ACTUAL USE IS UNKNOWN. I DON'T THINK IT IS USED IN PROGRAM. ???
;
; ----> _ARRAY  Doubles the top value on the stack (treats as offset), then
;                  redirects execution to _BARRAY.
;******************************************************************************************
...
;******************************************************************************************
; ----> _COM  Gets 16 bit number from stack, adds 1 and subtracts from zero. m=0-(p+1) ???
;******************************************************************************************
...
;******************************************************************************************
; ----> _0not_equal  True if m is not equal to zero.   m --- f
;******************************************************************************************

_0not_equal:         ld	de,$0000
                jp	not_equal2
